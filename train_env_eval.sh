...
do
    ...
    do
        python train_env.py\
            ...
            --train_file ${data_path}rl4rs_b_test.csv\
            ...
            --epoch 2\
            --seed 19\
            --model_path ${output_path}env/rl4rs_user_env_lr${LR}_reg${REG}_eval.model\
            --max_seq_len 50\
            --n_worker 4\
            --feature_dim 16\
            --hidden_dims 256\
            --attn_n_head 2\
            > ${output_path}env/log/rl4rs_user_env_lr${LR}_reg${REG}_eval.model.log
    done
done