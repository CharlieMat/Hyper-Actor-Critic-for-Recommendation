...
if __name__ == '__main__':
    ...
    init_parser.add_argument('--hypercritic_class', type=str, default='GeneralCritic', help='Critic class')
    init_parser.add_argument('--critic_class', type=str, default='Critic', help='Critic class')
