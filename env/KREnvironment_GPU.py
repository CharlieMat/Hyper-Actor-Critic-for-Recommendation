...
class KREnvironment_GPU(BaseRLEnvironment):
    @staticmethod
    ...
    def __init__(self, args):
        super(KREnvironment_GPU, self).__init__(args)
        ...
        assert class_args.reader == 'KRDataReader' and class_args.model == 'KRUserResponse'
        self.reader = KRDataReader(model_args)
        print("Loading user response model")
        self.user_response_model = KRUserResponse(model_args, self.reader, args.device)
