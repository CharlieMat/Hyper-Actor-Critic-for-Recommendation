...
#         self.portrait_vocab = get_vocab_of_seq_feature(self.data['train'], 'user_protrait')
    ...
    def __getitem__(self, idx):
        ...
        '''
        user_ID, slate_of_items, user_clicks, user_mid, user_likes, user_click_history, user_mid_history, user_like_history, sequence_id = self.data[self.phase].iloc[idx]
